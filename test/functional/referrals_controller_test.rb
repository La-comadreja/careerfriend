...
class ReferralsControllerTest < ActionController::TestCase
  ...
  test "should create referral" do
    assert_difference('Referral.count') do
      post :create, referral: { email: @referral.email, linkedin: @referral.linkedin, message: @referral.message, name: @referral.name, phone: @referral.phone }
    end
  ...
  test "should update referral" do
    put :update, id: @referral, referral: { email: @referral.email, linkedin: @referral.linkedin, message: @referral.message, name: @referral.name, phone: @referral.phone }
    assert_redirected_to referral_path(assigns(:referral))
  end
